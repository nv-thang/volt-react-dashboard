        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="IoT Dashboard" link={Routes.Presentation.path} image={ReactHero} />

              <NavItem title="Tổng quan" link={Routes.DashboardOverview.path} icon={faChartPie} />
              <NavItem title="Dữ liệu" icon={faTable} link={Routes.Transactions.path} />
              <NavItem title="Cài đặt" icon={faCog} link={Routes.Settings.path} />
              ...
              <CollapsableNavItem eventKey="documentation/" title="Giới thiệu" icon={faBook}>
              ...
              <CollapsableNavItem eventKey="components/" title="Liên hệ" icon={faBoxOpen}>
