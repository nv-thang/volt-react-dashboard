...
export const TransactionsTable = (props) => {
  ...
  const TableRow = (props) => {
    const { timestamp, temperature, sensorNode, lpg, humidity, dust, co2, co, ch4 } = props;
    ...
    return (
      <tr>
        ...
        <td>
          <span className={`fw-normal text-${dust}`}>
            {dust}
          </span>
        </td>
        <td>
        ...
        <Table hover className="user-table align-items-center">
          <thead>
            <tr>
              ...
              <th className="border-bottom">temperature</th>
              <th className="border-bottom">sensorNode</th>
              <th className="border-bottom">lpg</th>
              <th className="border-bottom">humidity</th>
              <th className="border-bottom">dust</th>
              <th className="border-bottom">co2</th>
              <th className="border-bottom">co</th>
              <th className="border-bottom">ch4</th>
              <th className="border-bottom">Action</th>
            </tr>
          </thead>
          <tbody>
            {props.data.map(t => <TableRow key={`key-${t.timestamp}`} {...t} />)}
          </tbody>
        </Table>
